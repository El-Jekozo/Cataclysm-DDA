...
class map
{
    ...
    public:
        ...
        */
        std::vector<item *> place_items( const item_group_id &gp, int chance, const tripoint &p1,
                                         const tripoint &p2, bool ongrass, const time_point &turn,
                                         int magazine = 0, int ammo = 0 );
        std::vector<item *> place_items( const item_group_id &gp, int chance, const point &p1,
                                         const point &p2, bool ongrass, const time_point &turn,
                                         int magazine = 0, int ammo = 0 ) {
            return place_items( gp, chance, tripoint( p1, abs_sub.z ), tripoint( p2, abs_sub.z ),
                                ongrass, turn, magazine, ammo );
        }
        /**
        ...
        */
        std::vector<item *> put_items_from_loc(
            const item_group_id &gp, const tripoint &p,
